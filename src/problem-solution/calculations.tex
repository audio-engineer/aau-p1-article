...
the average fuel efficiency, which is is 24 MPG (Miles Per Gallon)~\cite{price_mpg} and equals to 10.2 km per liter.
...
And finally, we'll have to multiply the price by 20, as the user will have to travel for the duaration of work month.
...
efficiency of 142 MPGe (Miles Per Gallon equivalent), which is about 60 km per liter equivalent~\cite{price_el}.
