...
% However, they do require electricity, which is often produced by burning fossil fuels.
% As we're using the Tesla Model 3 as our default EV, we'll be using data provided by Tesla to calculate the
% \unit{CO_{2}} emission.
% According to Tesla, the Model 3 emits an average of 14 grams of \unit{CO_{2}} per kilometer~\cite{co2_ev}.
% With that, we can calculate the \unit{CO_{2}} emission similarly to how we did with the trains and buses.
% TODO Undecided: Should we include EV CO2 emission?
