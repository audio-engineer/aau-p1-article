...
\begin{document}
    ...
    The problem has to be big enough to affect a big number of users and the solution has to be viable to be used by
    said users.
    ...
    There are already some solution to that issue, but from our `analysis over existing solutions', we figured that they
    are more fit for single trips, rather than every day travelling.
    ...
    At shorter distances, we would need to exclude planes, trains, and for people younger than 18, cars, making it a
    matter of whether the student should commute by walking or by bike, which are both CO2 friendly options.
    ...
    \subsection{Sender}\label{subsec:sender} % Spøgsmål: er afsenderen os eller AAU?
    ...
    others from the public transportation business~\cite{om_rejseplanen}, so if we were tasked by them to make a
    solution to the main problem, then they would be the senders.
    ...
    with their issue.
    We have made 3 personas, where each of them cover different age groups and have distinct characteristics related to
    the main problem.
...
% De ser heller ikke pænt ud, hvis Martin kan hjælpe med det ^_^
    ...
    \begin{tabular}{|l l|}
        ...
        & lives to the new job.
        He could compare different forms of \\
    ...
    \begin{tabular}{|l l|}
        ...
        & city.
        She is considering whether to take the s-train, the \\
        & train or a bus to university.
    ...
    \begin{tabular}{|l l|}
        ...
        & that for the sake of the environment.
